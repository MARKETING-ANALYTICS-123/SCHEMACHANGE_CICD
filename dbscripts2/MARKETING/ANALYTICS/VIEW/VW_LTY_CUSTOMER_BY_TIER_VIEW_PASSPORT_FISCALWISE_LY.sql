create or replace view VW_LTY_CUSTOMER_BY_TIER_VIEW_PASSPORT_FISCALWISE_LY(
	"Date Key",
	"Brand Name",
	"MasterCustomer ID",
...
LEFT JOIN EDW_MARKETING.ANALYTICS.VW_MKT_TIMESUMMARY MT ON MT."Last Year Id" = ts.TRANSACTIONTIMESTAMPFK
      LEFT OUTER JOIN cdp_jc.PUBLIC.timesummary t ON t.ID = MT.ID
