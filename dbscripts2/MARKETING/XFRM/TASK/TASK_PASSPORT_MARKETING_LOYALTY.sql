create or replace task TASK_PASSPORT_MARKETING_LOYALTY
	...
	as DECLARE
        ...
        V_TABLE_NAME STRING := 'PASSPORT MARKETING LOYALTY';
...
V_LAST_MODIFIED_TIME := (
    ...
    WHERE
        ...
        AND TABLE_NAME = 'PASSPORT MARKETING LOYALTY'
);
...
V_LAST_MODIFIED_LOYALTY_TIME := (
    ...
    WHERE
        ...
        IF(V_QUERY_TIME > V_LAST_MODIFIED_TIME AND V_LAST_MODIFIED_LOYALTY_TIME > V_LAST_MODIFIED_TIME AND V_QUERY_STATUS = 'SUCCESS') THEN
            CALL XFRM.USP_POPULATE_PASSPORT_MARKETING_LOYALTY();
            CALL EDW_MARKETING.XFRM.USP_POPULATE_BVT_VALIDATION('PASSPORT MARKETING');
        END IF;
    END;