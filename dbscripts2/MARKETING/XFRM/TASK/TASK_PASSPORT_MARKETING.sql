create or replace task TASK_PASSPORT_MARKETING
...
V_LAST_MODIFIED_TIME := (
    ...
    WHERE
        ...
        AND TABLE_NAME = 'PASSPORT MARKETING'
);
      ...
      IF(V_QUERY_TIME > V_LAST_MODIFIED_TIME AND V_QUERY_STATUS = 'SUCCESS') THEN
           ...
           CALL XFRM.USP_POPULATE_PASSPORT_CUSTOMER();
           CALL XFRM.USP_POPULATE_PASSPORT_MARKETING();
       END IF;
    END;