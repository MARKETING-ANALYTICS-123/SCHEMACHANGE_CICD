CREATE OR REPLACE PROCEDURE "USP_POPULATE_RETENTION_PASSPORT_DYNAMIC_DATE"()
RETURNS VARCHAR(100)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
BEGIN
    ...
    TRUNCATE TABLE RPT."PASSPORT RETENTION L12";
    ...
    DO
        ...
        CALL XFRM.USP_POPULATE_RETENTION_12M_PASSPORT(:start_dates, :end_dates, :currentYear, :currentMonth);
